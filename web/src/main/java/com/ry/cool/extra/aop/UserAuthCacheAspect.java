 ...
 */
package com.ry.cool.extra.aop;

import com.ry.cool.common.cache.BaseCacheAspect;
import com.ry.cool.sys.auth.entity.Auth;
import com.ry.cool.sys.auth.service.AuthService;
import com.ry.cool.sys.auth.service.UserAuthService;
 ...
 * <p/>
 * 1、当调用如下方法时，加缓存
 * {@link UserAuthService#findRoles}
 * {@link UserAuthService#findStringRoles}
 * {@link UserAuthService#findStringPermissions}
 * <p/>
 * 2、授权（Auth）
 * 当增删改授权时，
 * 如果是用户相关的，只删用户的即可，
...
public class UserAuthCacheAspect extends BaseCacheAspect {
     ...
     * 其他的全部清理
     */
    @Pointcut(value = "target(com.ry.cool.sys.auth.service.AuthService)")
     ...
     * 当删除资源时，清缓存
     */
    @Pointcut(value = "target(com.ry.cool.sys.resource.service.ResourceService)")
     ...
     * 当删除权限时，清缓存
     */
    @Pointcut(value = "target(com.ry.cool.sys.permission.service.PermissionService)")
     ...
     * 当修改角色show/role/resourcePermissions关系时，清缓存
     */
    @Pointcut(value = "target(com.ry.cool.sys.permission.service.RoleService)")
     ...
     * 当删除/修改show字段时，清缓存
     */
    @Pointcut(value = "target(com.ry.cool.sys.organization.service.OrganizationService)")
     ...
     * 当删除/修改show字段时，清缓存
     */
    @Pointcut(value = "target(com.ry.cool.sys.organization.service.JobService)")
     ...
     * 当删除组时，清缓存
     */
    @Pointcut(value = "target(com.ry.cool.sys.group.service.GroupService)")
     ...
     * 其他情况，清所有
     */
    @Pointcut(value = "target(com.ry.cool.sys.group.service.GroupRelationService)")
     ...
     * 修改时，如果组织机构/工作职务变了，仅需清自己的缓存
     */
    @Pointcut(value = "target(com.ry.cool.sys.user.service.UserService)")
    ...
    @Pointcut(value = "target(com.ry.cool.sys.auth.service.UserAuthService)")
