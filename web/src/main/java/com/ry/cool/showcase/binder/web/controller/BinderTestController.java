 ...
 */
package com.ry.cool.showcase.binder.web.controller;
...
public class BinderTestController {
    ...
    //http://localhost:9080/cool-web/binder/test1?user1.id=1&user2.id=2
    ...
    //http://localhost:9080/cool-web/binder/test2?user3.id=1&user3.username=123
