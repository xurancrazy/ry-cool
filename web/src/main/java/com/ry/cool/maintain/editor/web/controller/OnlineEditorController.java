 ...
 */
package com.ry.cool.maintain.editor.web.controller;

import com.google.common.collect.Lists;
import com.ry.cool.common.Constants;
import com.ry.cool.common.utils.LogUtils;
import com.ry.cool.common.utils.MessageUtils;
import com.ry.cool.common.web.controller.BaseController;
import com.ry.cool.common.web.entity.AjaxUploadResponse;
import com.ry.cool.common.web.upload.FileUploadUtils;
import com.ry.cool.common.web.upload.exception.FileNameLengthLimitExceededException;
import com.ry.cool.common.web.upload.exception.InvalidExtensionException;
import com.ry.cool.common.web.utils.DownloadUtils;
import com.ry.cool.maintain.editor.web.controller.utils.CompressUtils;
import com.ry.cool.maintain.editor.web.controller.utils.OnlineEditorUtils;
...
public class OnlineEditorController extends BaseController {
    ...
    public String tree(Model model) throws UnsupportedEncodingException {
        ...
        Map<Object, Object> root= OnlineEditorUtils.extractFileInfoMap(rootDirectory, rootPath, id, -1);
        ...
        for(File subFile : rootDirectory.listFiles()) {
            ...
            id++;
            trees.add(OnlineEditorUtils.extractFileInfoMap(subFile, rootPath, id, (Long)root.get("id")));
        }
    ...
    public Object ajaxLoad(
        ...
        for(File subFile : parentPathDirectory.listFiles()) {
            ...
            id++;
            trees.add(OnlineEditorUtils.extractFileInfoMap(subFile, rootPath, id, parentId));
        }
        return trees;
    }
    ...
    public String listFile(
        ...
        Map<Object, Object> current = OnlineEditorUtils.extractFileInfoMap(currentDirectory, rootPath);
        current.put("name", currentDirectory.getName());

        Map<Object, Object> parent = null;
        if(OnlineEditorUtils.hasParent(currentDirectory, rootPath)) {
            File parentDirectory = currentDirectory.getParentFile();
            parent = OnlineEditorUtils.extractFileInfoMap(parentDirectory, rootPath);
        ...
        for(File subFile : currentDirectory.listFiles()) {
            files.add(OnlineEditorUtils.extractFileInfoMap(subFile, rootPath));
        }

        OnlineEditorUtils.sort(files, sort);
