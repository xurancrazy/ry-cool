...
create table `personal_message`(
  ...
  `sender_id`        bigint,
  `receiver_id`      bigint,
  `send_date`        timestamp default '1970-01-02 00:00:00',
  `title`            varchar(200),
  `sender_state`     varchar(20),
  `sender_state_change_date`    timestamp  default '1970-01-02 00:00:00',
  `receiver_state`   varchar(20),
  `receiver_state_change_date`    timestamp  default '1970-01-02 00:00:00',
  `type`            varchar(20) ,
  `is_read`            bool ,
  `is_replied`          bool ,
  `parent_id`        bigint,
