...
create table `sys_user`(
  ...
  `salt`       varchar(10),
  `create_date` timestamp default '1970-01-02 00:00:00',
  `status`    varchar(50),
  `deleted`   bool,
  `admin`     bool,
...
create table `sys_user_status_history`(
  ...
  `reason`     varchar(200),
  `op_user_id`  bigint,
  `op_date`    timestamp default '1970-01-02 00:00:00' ,
...
create table `sys_user_online`(
  ...
  `status`  varchar(50),
  `start_timestsamp`    timestamp default '1970-01-02 00:00:00' ,
  `last_access_time`    timestamp default '1970-01-02 00:00:00' ,
  `timeout`    bigint ,
  `session` mediumtext,
...
create table `sys_user_last_online`(
  ...
  `user_agent` varchar(200),
  `system_host`  varchar(100),
  `last_login_timestamp`    timestamp default '1970-01-02 00:00:00' ,
  `last_stop_timestamp`    timestamp default '1970-01-02 00:00:00' ,
  `login_count`    bigint ,
