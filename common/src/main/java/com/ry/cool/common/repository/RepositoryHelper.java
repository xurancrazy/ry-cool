...
import com.ry.cool.common.repository.callback.SearchCallback;
import com.ry.cool.common.repository.support.annotation.EnableQueryCache;
...
public class RepositoryHelper {
     ...
     * <p/>
     * 测试用例请参考：{@see com.ry.cool.common.repository.UserRepositoryImplForCustomSearchIT}
     * 和{@see com.ry.cool.common.repository.UserRepositoryImplForDefaultSearchIT}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see com.ry.cool.common.repository.UserRepository2ImplIT#testFindAll()}
     *
     * @param ql
     ...
     * 具体使用请参考测试用例：{@see com.ry.cool.common.repository.UserRepository2ImplIT#testFindOne()}
     *
     * @param ql
     * @param params
     * @param <M>
     ...
     * 具体使用请参考测试用例：com.ry.cool.common.repository.UserRepository2ImplIT#testCountAll()
     *
     * @param ql
     * @param params
     * @return
     ...
     * 具体使用请参考测试用例：{@see com.ry.cool.common.repository.UserRepository2ImplIT#testBatchUpdate()}
     *
     * @param ql
     * @param params
     * @return
